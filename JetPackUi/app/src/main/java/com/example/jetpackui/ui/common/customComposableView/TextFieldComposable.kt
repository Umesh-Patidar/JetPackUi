package com.example.jetpackui.ui.common.customComposableView
    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            IconButton(onClick = { isPasswordVisible = !isPasswordVisible}) {
                ...
                val passwordVisibilityIconAndText = if (isPasswordVisible) visibleIconAndText else hiddenIconAndText
                Icon(
